...
This document details the Intel's vRAN accelerator devices/hardware supported by the [SEO Operator for Wireless FEC Accelerators](https://github.com/otcshare/sriov-fec-operator/blob/master/spec/openshift-sriov-fec-operator.md) in Red Hat's OpenShift Container Platform.
...
* [SEO Operator for Wireless FEC Accelerators](https://github.com/otcshare/sriov-fec-operator/blob/master/spec/openshift-sriov-fec-operator.md)
